# Advent of Code 2023.  
# Day 12:  Hot Springs
# Part 1:  How many possibilities of replacing ? with # or . ? 
...
proc pound {} {
    ...
    # puts "pound: $record {$groups} $next_group"
    ...
    # If the rest of the record is just the last group, the we're
...
foreach line $lines {
    lassign [split $line] record raw_groups
    set groups [split $raw_groups ","]
