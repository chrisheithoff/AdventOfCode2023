...
# Part 2: How much cubic meters of lava?  Oh actualy, the RGB is the hex distance and dir
...
foreach line $lines {
    set hex [lindex $line 2]
    scan $hex {(#%5s%1s)} distance dir
    set dir [lindex {R D L U} $dir]
    set distance "0x$distance"
